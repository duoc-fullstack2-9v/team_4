...
function Productos() {
    ...
    // Grupo 2: postres sin azúcar o con mousse
    const productos2 = [
    ...
    // Grupo 4: opciones veganas y especiales
    const productos4 = [
    ...
    // Agrupamos todos los productos en un solo arreglo de arreglos
    const productos = [
        productos1,
        productos2,
        productos3,
    ...
    return (
        <>
            ...
            <Main productos={productos} /> {/* Componente que mostrará las tarjetas de productos */}
